  ...
  return (
    <div className="mt-4">
      {result?.comment_with_emotion.map((comment, index) => (
        <div
          key={index}
          className="truncate my-6 flex flex-col items-start gap-4 bg-gradient-to-br from-main-pink gap-4 border-2 border-black p-2 rounded-md w-[80%] shadow-[0_4px_1px_1px_rgba(0,0,0,0.3)]"
        >
          <p className="truncate text-over font-semibold text-[1.25rem]">
            {comment[0]}
          </p>
